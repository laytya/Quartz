...
lib.altEnabledFrames = lib.altEnabledFrames  or {}
...
lib.utilFrame:SetScript("OnUpdate", function()
	...
	for frame,_ in pairs(lib.altEnabledFrames) do
		if not lib.windowData[frame].isDragging then		-- if it's already dragging, it'll disable mouse on DragStop instead
			...
			frame:EnableMouseWheel(not not IsControlKeyDown())
		end
	end
...
local function onMouseWheel() print("mousewheel", arg1) ; return lib.OnMouseWheel(this,arg1) end  -- upgradable
